%define module fcdslusb2
%define version 3.11.07
%define card "AVM FRITZ!Card DSL USB v2.0"
...
Source3: dkms-fcdslusb2-remove-usb_driver_owner.patch
Source4: dkms-fcdslusb2-remove-DECLARE_MUTEX_LOCKED.patch
Source5: dkms-fcdslusb2-update-INIT_WORK-changes.patch
Source6: dkms-fcdslusb2-update-usb_complete_t-functions.patch
...
CLEAN="make clean"
AUTOINSTALL="yes"
PATCH[0]="dkms-fcdslusb2-use-autoconf-header.patch"
...
PATCH[5]="dkms-fcdslusb2-update-usb_complete_t-functions.patch"
PATCH_MATCH[5]="^2\.6\.(19)|([2-9][0-9]+)|([1-9][0-9][0-9]+)"
EOF

cp -LR . $RPM_BUILD_ROOT/usr/src/%module-%version-%release/

for p in %{_sourcedir}/dkms-fcdslusb2-use-autoconf-header.patch \
         %{_sourcedir}/dkms-fcdslusb2-dont-redefine-uintptr_t.patch \
         %{_sourcedir}/dkms-fcdslusb2-remove-usb_driver_owner.patch \
         %{_sourcedir}/dkms-fcdslusb2-remove-DECLARE_MUTEX_LOCKED.patch \
         %{_sourcedir}/dkms-fcdslusb2-update-INIT_WORK-changes.patch \
         %{_sourcedir}/dkms-fcdslusb2-update-usb_complete_t-functions.patch;
do
